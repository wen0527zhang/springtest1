...
import com.neworange.detect.translator.AbstractOnnxRuntimeTranslator;
import com.neworange.entity.Letterbox;
...
public class Yolov8sOnnxRuntimeDetect extends AbstractOnnxRuntimeTranslator {
    ...
    public static Yolov8sOnnxRuntimeDetect criteria() throws OrtException, IOException {
        ...
        String modelPath = PathConstants.TEMP_DIR+PathConstants.ONNX+ File.separator+"yolov8s.onnx";
