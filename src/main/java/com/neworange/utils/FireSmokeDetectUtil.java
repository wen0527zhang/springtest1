...
import com.neworange.detect.FireSmokeDetect;
...
public class FireSmokeDetectUtil {
    ...
    private static final Logger logger = LoggerFactory.getLogger(FireSmokeDetectUtil.class);

    private FireSmokeDetectUtil() {
    }
    ...
    public static DetectedObjects runOcr(String path) throws IOException, ModelException, TranslateException {
        ...
        Criteria<Image, DetectedObjects> criteria = new FireSmokeDetect(arguments).criteria();
